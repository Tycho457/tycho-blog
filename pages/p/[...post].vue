  ...
  <section class="prose relative slide-enter-content">
    <ContentDoc :path="path">
      <template #default="{ doc }">
        ...
        <Giscus
          repo="tycho457/nuxt3-blog" repo-id="R_kgDOKGidhw" category="General"
          category-id="DIC_kwDOKGidh84CYkoQ" mapping="title" term="Welcome to my blog!" reactions-enabled="1"
